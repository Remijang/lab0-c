 ...
 */
__attribute__((nonnull(2, 3, 4))) static struct list_head *merge(
    void *priv,
...
int compare(void *priv, struct list_head *a, struct list_head *b)
{
    ...
    return descend ? (c * -1) : c;
}

void linux_list_sort(struct list_head *head, bool descend)
{
    return list_sort((void *) &descend, head, compare);
}
